...
use App\Http\Controllers\Backend\Student\StudentFeeController;
use App\Http\Controllers\Backend\Admin\BulkFeeController;
use App\Http\Controllers\Backend\Admin\FeeCategoryController;
use App\Http\Controllers\Backend\Admin\FeeRulesController;
use App\Http\Controllers\PaymentController;
use App\Http\Controllers\Backend\Admin\AdminReportController;
use App\Http\Controllers\Backend\Student\StudentReportController;
use App\Http\Controllers\Backend\Student\FeeInfoController;
use App\Http\Controllers\Backend\Student\ClearanceFormController;
use App\Http\Controllers\Backend\Admin\AdminClearanceController;
...
Route::middleware(['auth', 'role:2'])->group(function () {
  ...
  Route::get('admin/fees', [FeeController::class, 'index'])->name('admin.fees.index');
  Route::get('admin/fees/create', [FeeController::class, 'create'])->name('admin.fees.create');
  Route::post('admin/fees', [FeeController::class, 'store'])->name('admin.fees.store');
  Route::get('admin/fees/{fee}/edit', [FeeController::class, 'edit'])->name('admin.fees.edit');
  ...
  Route::post('/fees/bulk-create', [BulkFeeController::class, 'bulkCreate'])->name('fees.bulk-create.store');
  Route::post('/fees/create-bulk-fee-records', [BulkFeeController::class, 'createBulkFeeRecords'])->name('fees.create-bulk-fee-records');

  // Admin Receipts
  Route::get('admin/receipts', [FeeController::class, 'adminReceipts'])->name('admin.receipts.index');
  Route::get('/admin/receipts/{paymentId}/generate', [FeeController::class, 'adminGenerateReceipt'])->name('admin.generate.receipt');

  // Fee Categories
  Route::get('/fee-categories', [FeeCategoryController::class, 'index'])->name('fee-categories.index');
  Route::post('/fee-categories/store', [FeeCategoryController::class, 'store'])->name('fee-categories.store');
  Route::put('/fee-categories/{id}/update', [FeeCategoryController::class, 'update'])->name('fee-categories.update');
  Route::delete('/fee-categories/{id}/delete', [FeeCategoryController::class, 'destroy'])->name('fee-categories.delete');

  // Rules
  Route::get('{feeCategoryId}', [FeeRulesController::class, 'index'])->name('fee-rules.index');
  Route::post('{feeCategoryId}', [FeeRulesController::class, 'store'])->name('fee-rules.store');
  Route::put('{ruleId}', [FeeRulesController::class, 'update'])->name('fee-rules.update');
  Route::delete('{ruleId}', [FeeRulesController::class, 'destroy'])->name('fee-rules.destroy');
  ...
  Route::post('/admin/clearance-form/bulk-download', [AdminClearanceController::class, 'bulkDownload'])->name('admin.clearance-form.bulk-download');
  Route::get('/admin/clearance-form/view/{id}', [AdminClearanceController::class, 'view'])->name('admin.clearance-form.view');
});
...
Route::middleware(['auth', 'role:3'])->group(function () {
  ...
  //How to Make Payment Info
  // Route::get('/payment-info', function () {
  //   return view('student.fees.info');
  //   })->name('payment.info');
  Route::get('/fees/info', [FeeInfoController::class, 'index'])->name('payment.info');
  Route::post('/fees/info/store', [FeeInfoController::class, 'showPaymentInstructions'])->name('info.store');

  // Student Fee Management Routes
  Route::get('student/fees', [StudentFeeController::class, 'index'])->name('fees.index');
  Route::get('/student/fees/upload/{fee}', [StudentFeeController::class, 'uploadPaymentProof'])->name('fees.upload');
  Route::post('/student/fees/store/{fee}', [StudentFeeController::class, 'storePaymentProof'])->name('fees.store'); // Store payment proof

  // Student Receipts
  Route::get('/student/receipts', [StudentFeeController::class, 'studentReceipts'])->name('student.receipts.index');
  ...
  Route::post('/student/clearance-form/upload', [ClearanceFormController::class, 'uploadForm'])->name('clearance.upload');
});
...
// Route::post('/auth/login-basic/user', [AuthController::class, 'LoginUser'])->name('LoginUser');
