                    ...
                    <div class="row mx-0 px-3 row-gap-6">
                        <div class="col-md-8 ps-0">
                            <div class="d-flex svg-illustration align-items-center gap-2 mb-6">
                                ...
                                <span
                                    class="mb-0 app-brand-text demo fw-semibold">{{ config('variables.templateName') }}</span>
                            </div>
                            ...
                            <dl class="row mb-0 gx-4">
                                ...
                                <dd class="col-sm-7">
                                    <div class="input-group input-group-merge input-group-sm">
                                        ...
                                        <input type="text" class="form-control" placeholder="45678" value="45678"
                                            id="invoiceId" />
                                    </div>
                                </dd>
                                <dt class="col-sm-5 mb-2 d-md-flex align-items-center justify-content-start">
                                ...
                                <dd class="col-sm-7">
                                    <input type="text" class="form-control form-control-sm invoice-date"
                                ...
                                <dd class="col-sm-7 mb-0">
                                    <input type="text" class="form-control form-control-sm due-date"
                                ...
                                <div class="d-flex border rounded position-relative pe-0">
                                    <div class="row w-100 p-5 gx-5">
                                        ...
                                        <div class="col-md-2 col-12 mb-md-0 mb-4">
                                            ...
                                            <input type="text" class="form-control invoice-item-qty" value="1"
                                    ...
                                    <div
                                        ...
                                        <div class="dropdown">
                                            <i class="ri-settings-3-line cursor-pointer more-options-dropdown"
                        ...
                        <div class="row">
                            <div class="col-12">
                                <button type="button" class="btn btn-primary btn-sm" data-repeater-create><i
                                        class="ri-add-line ri-14px me-1_5"></i> Add Item</button>
                            </div>
                        </div>
                    </form>
                </div>
                ...
                <div class="card-body">
                    <button class="btn btn-primary d-grid w-100 mb-4" data-bs-toggle="offcanvas"
                        ...
                        <span class="d-flex align-items-center justify-content-center text-nowrap"><i
                                class="ri-send-plane-line ri-16px scaleX-n1-rtl me-2"></i>Send Invoice</span>
                    </button>
                    <div class="d-flex">
                        <a href="{{ url('app/invoice/preview') }}"
                            class="btn btn-outline-secondary w-100 me-4 mb-4">Preview</a>
                    ...
                    <button class="btn btn-success d-grid w-100" data-bs-toggle="offcanvas"
                        ...
                        <span class="d-flex align-items-center justify-content-center text-nowrap"><i
                                class="ri-money-dollar-circle-line ri-16px me-2"></i>Add Payment</span>
                    </button>
                </div>
            </div>
            <div>
