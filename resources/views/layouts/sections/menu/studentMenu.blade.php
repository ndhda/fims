...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  ...
  <div class="app-brand demo">
      <a href="{{ url('/') }}" class="app-brand-link">
          ...
          <span class="app-brand-text demo menu-text fw-semibold ms-2">Student Panel</span>
      </a>
  ...
  <ul class="menu-inner py-1">
      ...
      <li class="menu-item">
          ...
          <ul class="menu-sub">
              <li class="menu-item">
                <a href="{{ route('payment.info') }}" class="menu-link">
              ...
              <li class="menu-item">
                  <a href="{{ route('student.receipts.index') }}" class="menu-link">
                      <div>Receipts</div>
                  </a>
              </li>
              <li class="menu-item">
      ...
      <li class="menu-item">
          <a href="{{ route('clearance.form') }}" class="menu-link">
              <i class="menu-icon tf-icons bx bx-history"></i>
              <div>Clearance Form Submission</div>
          </a>
      </li>
