...
<footer class="landing-footer">
            ...
            <div class="row gx-0 gy-7 gx-sm-6 gx-lg-12">
                <div class="col-lg-5">
                    <a href="{{ url('front-pages/landing') }}" class="app-brand-link mb-6">
                        <span class="app-brand-logo demo me-2"><img width="40"
                                src="{{ asset('assets/img/branding/logo.png') }}"></span>
                        <span
                            class="app-brand-text demo footer-link fw-semibold ms-1">{{ config('variables.templateName') }}</span>
                    </a>
    ...
    <div class="footer-bottom py-5">
        <div
            ...
            <div>
                <a href="{{ config('variables.githubUrl') }}" class="footer-link me-4" target="_blank"><i
