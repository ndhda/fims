...
@php
    // Assuming the user's role is stored in session or as part of user object
...
<div class="layout-wrapper layout-content-navbar {{ $isMenu ? '' : 'layout-without-menu' }}">
  <div class="layout-container">
    ...
    @if ($isMenu)
    @php
        $roleId = Auth::user()->role_id ?? null; // Replace with your actual method to fetch the role ID
    @endphp
